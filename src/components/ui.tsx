...
/** Adds .revealed when the element scrolls into view (see index.css). */
...
export function Tag({ children }: { children: ReactNode }) {
  return (
    <span className="rounded-full border border-line bg-ink px-2.5 py-0.5 font-mono text-xs text-fog">
      {children}
    </span>
  );
}
